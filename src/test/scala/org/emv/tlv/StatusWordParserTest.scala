...
/**
  * Created by lau on 6/21/16.
  */
class StatusWordParserTest extends FlatSpec with Matchers {

//  "A Acquirer Identifier" should " be able to parse" in {
//    val input = "61FF".fromHex
//
//        EMVTLV.EMVParser.parse(EMVTLV.EMVParser.parseStatusWord, input) match {
